...
//        seller_percentage = get_user_meta( $user->ID, 'dokan_seller_percentage', true );
        ...
        <table class="form-table">
            <tbody>
                ...
                <tr>
                    ...
                    <td>
                        <label for="dokan_enable_selling">
                            ...
                            <input name="dokan_enable_selling" type="checkbox" id="dokan_enable_selling" value="yes" <?php checked( $selling, 'yes' ); ?> checked/>
                ...
                <tr>
                    ...
                    <td>
                        <label for="dokan_publish">
                            ...
                            <input name="dokan_publish" type="checkbox" id="dokan_publish" value="yes" <?php checked( $publishing, 'yes' ); ?> checked/>
                ...
                <?php echo esc_attr( $admin_commission );  ?>
                <tr>
